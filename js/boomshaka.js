...
jQuery(document).ready(function() { 
	/* this is intended to customize the customization screen appropriately for us */
	//add the three classes to the container
	var createBoomshakaCustomizer = function() {
		...
		$("#customize-theme-controls ul").append(boomshakaCustomizerContainer);
		$("#customize-theme-controls ul").append(boomshakaCustomizerTitle);
		$("#customize-theme-controls ul").append(boomshakaCustomizerContentContainer);
	};
	//createBoomshakaCustomizer();
});